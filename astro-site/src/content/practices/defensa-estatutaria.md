...
servicesIncluded:
  - icon: "📋"
    ...
    description: "Defensa completa en procedimientos disciplinarios, investigaciones sumarias y formulación de cargos."
  - icon: "🚫"
    title: "Término de Contrata"
    description: "Recursos y estrategias legales ante no renovación o término anticipado injustificado."
  - icon: "🚨"
...
process:
  ...
  - step: 3
    title: "Representación y Ejecución"
    description: "Ejecutamos la defensa: descargos, recursos, comparecencias y seguimiento de plazos críticos."
  - step: 4
