...
servicesIncluded:
  - icon: "🎓"
    ...
    description: "Programas de formación en profundidad sobre materias específicas con certificación de asistencia."
  - icon: "💬"
    title: "Charlas Informativas"
    description: "Sesiones focalizadas de 1-2 horas para abordar temas puntuales de interés organizacional."
  - icon: "🛠️"
...
process:
  ...
  - step: 3
    title: "Ejecución de la Capacitación"
    description: "Impartición del programa en modalidad presencial o remota, según preferencia y necesidades."
  - step: 4
    title: "Evaluación y Seguimiento"
    description: "Entrega de material de apoyo, evaluación de satisfacción y período de consultas post-capacitación."
...
## Áreas temáticas más solicitadas

- **Ley Karin**: Prevención del acoso laboral y sexual en organizaciones
- **Estatuto Administrativo**: Derechos y obligaciones de funcionarios públicos
