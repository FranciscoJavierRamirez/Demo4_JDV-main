...
servicesIncluded:
  - icon: "📋"
    ...
    description: "Gestión extrajudicial para recuperar deudas: cartas de cobranza, negociación y acuerdos de pago."
  - icon: "⚡"
    title: "Juicios Ejecutivos"
    description: "Cobro judicial de pagarés, cheques, facturas y títulos ejecutivos con embargo de bienes."
  - icon: "🏠"
    title: "Juicios de Arrendamiento"
    description: "Terminación de contratos, cobro de rentas impagas y restitución de inmuebles (Devuélveme mi casa)."
  - icon: "📝"
    title: "Litigios Contractuales"
    description: "Demandas por incumplimiento, resolución de contratos e indemnización de perjuicios."
  - icon: "⚖️"
    title: "Indemnizaciones Civiles"
    description: "Demandas por daño emergente, lucro cesante, daño moral y responsabilidad extracontractual."
  - icon: "🤝"
    title: "Arbitrajes y Mediación"
    description: "Resolución alternativa de conflictos mediante arbitraje o mediación cuando convenga."
...
process:
  ...
  - step: 3
    ...
    description: "Si no hay acuerdo, iniciamos la demanda correspondiente con estrategia definida y plazos claros."
  - step: 4
...
faq:
  ...
  - question: "¿Puedo cobrar los gastos del juicio al deudor?"
    answer: "Sí, en juicios ejecutivos y ordinarios el tribunal puede condenar en costas al perdedor, incluyendo honorarios y gastos judiciales. Esto se suma al monto de la deuda original."
  - question: "¿Qué pasa si el deudor no tiene bienes a su nombre?"
...
**Cobranzas y juicios ejecutivos:**
- Cobro de pagarés, cheques y letras de cambio
- Facturas impagas con acuse de recibo
- Mutuos e hipotecas
- Títulos ejecutivos diversos

**Arrendamientos:**
- Término de contrato por no pago
- Restitución de inmuebles (Devuélveme mi casa)
- Cobro de rentas y gastos comunes adeudados
